...
After going north from Couloir 2 for the first time:
	say "You sneak into the wolf's den, a place that is well known to you, but still terrifying. As usual, the wolf is imprisoned in an iron cage and you are free to explore, beyond the reach of his slaving fangs.";
	try looking;
	increment the knownCommands of the Player.
