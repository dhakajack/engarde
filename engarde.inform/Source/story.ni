...
Check simpleTalking:
	if the player is not in the sas:
		...
		stop the action;
	otherwise:
		if the bloody corpse of Doctor Rambaud is in the sas:
...
After eating scientist:
	...
	move the electrical panel to escalier 1;
...
The microfluidic synthesis unit is an openable closed container in the void. 

The servomoteur is in the microfluidic synthesis unit. The servomoteur is broken. The printed name of the servomoteur is "[pnServo]".
