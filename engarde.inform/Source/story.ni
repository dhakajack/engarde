...
The tupperware container is a  closed openable container in the frigo. The tupperware container is closed.
...
Instead of simpleEating when the player is in Les Toilettes:
	...
	otherwise:
		if the consciousness of the player is:
			-- 2:
				say "You [one of]lap up the water in the bowl. It's refreshing[or]aren't really thirsty, but you drink some water[or]you are no longer thirsty having already guzzled down a few liters of water[stopping].";
			-- 3:
...
mouseDogDialogue is {
"[quotation mark]Sorry[quotation mark][line break][quotation mark]Sorry about what?[quotation mark][line break][quotation mark]I guess, I'm sorry that I ate you.[quotation mark][line break][quotation mark]Ate me? Who are you, anyhow?[quotation mark][line break][quotation mark]The mouse.[quotation mark]",
...
"[quotation mark]Lucky, do you think that some day you'll find your family?[quotation mark][line break][quotation mark]Hope so.[quotation mark][line break][quotation mark]Me too. I'd like to chase squirrels with you.[quotation mark][line break][quotation mark]Yeah, that would be great.[quotation mark]"
}
